...
<body>
  <div class="hero_area">
    ...
    <div class="container" style="margin-top: 20px;margin-bottom: 20px;padding: 20px;height: 300px;">
      <div class="row">
        <form:form action="/reservation/fetchreservationbydate" method="post" modelAttribute="reservation">
          <div class="form-group">
            <label for="reservationDate">Reservation Date</label>
            <form:input path="reservationDate" class="form-control" id="reservationDate"/>
          </div>
