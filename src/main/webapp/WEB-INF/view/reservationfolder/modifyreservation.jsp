...
<body>
  <div class="hero_area">
    ...
    <div class="container" style="margin-top: 20px;margin-bottom: 30px;padding: 30px;height: 300px; margin-left: 50px;">
      <div class="row">
        <form:form action="/reservation/fetchreservation" method="post" modelAttribute="reservation">
          ...
          <div class="form-group">
            <button class="btn btn-success" style="margin-left: 40px">Update activity</button>
          </div>
