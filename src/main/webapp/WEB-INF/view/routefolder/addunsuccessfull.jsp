...
<body>
  <div class="hero_area">
    ...
    <div class="alert alert-danger"><b>Feedback addition is unsuccessfull</b></div>
    <br>
    <div class="container" style="margin-top: 20px;margin-bottom: 30px;padding: 30px;height: 300px; margin-left: 50px;">
      <div class="row">
        <form:form action="/feedback/addfeedback" method="get" modelAttribute="route">
            <div class="form-group" style="margin-left:500px;">
              <button class="btn btn-primary"><b>Retry</b></button>
            </div>
        </form:form> 
      </div>
    </div>
