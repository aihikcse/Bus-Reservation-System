...
<body>
  <div class="hero_area">
    ...
    <div class="alert alert-danger"><b>Route not found</b></div>
    <br>
    <form:form action="/route/updateroute" method="get" modelAttribute="route">
      <form:hidden path="routeId" class="form-control" id="routeid"/>
